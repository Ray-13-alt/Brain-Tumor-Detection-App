...
class Gui:
    ...
    def __init__(self):
        ...
        MainWindow.configure(background="cyan")  # Set background color to Cyan
        ...
        # Adding Introduction
        intro_label = tkinter.Label(self.FirstFrame.getFrames(), text="KJSCE : **Welcome to Brain Tumor Detection System**", height=2, width=50)
        intro_label.place(x=320, y=30)
        intro_label.configure(background="White", font=("Comic Sans MS", 16, "bold"))

        # Introduction to Brain Tumors
        brain_tumor_text = """A brain tumor is an abnormal mass or growth of cells in the brain. 
        There are many types of brain tumors, and their symptoms and treatment vary.
        Symptoms of brain tumors may include headaches, seizures, difficulty speaking or
        comprehending, and changes in vision or hearing."""
        brain_tumor_label = tkinter.Label(self.FirstFrame.getFrames(), text=brain_tumor_text, justify='left', wraplength=600)
        brain_tumor_label.place(x=320, y=100)

        # Developers Information
        developer_text = "Developed by Samarjit and Shivam"
        developer_label = tkinter.Label(self.FirstFrame.getFrames(), text=developer_text, height=1, width=30)
        developer_label.place(x=320, y=400)
        developer_label.configure(background="White", font=("Comic Sans MS", 12))
